...
export const ForensicTerminal = ({ logs }: ForensicTerminalProps) => {
  ...
  return (
    <div className="h-full flex flex-col bg-slate-950 rounded-lg border border-slate-800/50 overflow-hidden">
      {/* Terminal Header */}
      <div className="flex items-center gap-2 px-4 py-2 bg-slate-900/80 border-b border-slate-800/50">
        <Terminal className="w-4 h-4 text-cyan-500" />
        <span className="text-xs font-mono text-slate-400">forensic_terminal</span>
