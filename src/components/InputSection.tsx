          ...
          <div className="flex flex-col sm:flex-row gap-2">
            <div className="relative flex-1">
              ...
              <input
                ...
                disabled={isLoading}
                className="w-full h-14 pl-12 pr-4 bg-background/50 rounded-xl text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all disabled:opacity-50"
              />
            </div>
            <Button
              type="submit"
                  ...
                  {loadingSteps.map((step, i) => (
                    <motion.div
                      ...
                      className={`w-2 h-2 rounded-full ${
                        loadingSteps.indexOf(loadingStep) >= i
                          ? "bg-primary"
                          : "bg-muted"
                      }`}
                      initial={{ scale: 0.8 }}
          ...
          <div className="flex flex-wrap justify-center gap-2">
            {[
              ...
              <button
                ...
                className="px-3 py-1.5 text-sm rounded-lg bg-muted/50 text-muted-foreground hover:bg-muted hover:text-foreground transition-colors"
              >
                {repo}
              </button>
            ))}
